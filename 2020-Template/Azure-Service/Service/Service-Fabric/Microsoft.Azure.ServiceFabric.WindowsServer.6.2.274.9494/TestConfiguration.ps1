...
$argList = @($DeployerBinPath, $ServiceFabricPowershellModulePath, $ClusterConfigFilePath, $OldClusterConfigFileAbsolutePath, $MicrosoftServiceFabricCabFileAbsolutePath, $MaxPercentFailedNodes)
Powershell -Command {
    param (
        [Parameter(Mandatory=$true)]
        $DeployerBinPath,
    ...
    Try 
    {
        Test-ServiceFabricConfiguration -ClusterConfigurationFilePath $ClusterConfigFilePath -OldClusterConfigurationFilePath $OldClusterConfigFilePath -FabricRuntimePackagePath $MicrosoftServiceFabricCabFileAbsolutePath -MaxPercentFailedNodes $MaxPercentFailedNodes
    }
    Catch
    {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUPSdfxopWB/khyg4yMxbA91yu
# CL6gghhUMIIEwjCCA6qgAwIBAgITMwAAAL+RbPt8GiTgIgAAAAAAvzANBgkqhkiG
...
# BDEWBBRVgX9+4LTwE3DEmcyi+O0+EV2dVTBaBgorBgEEAYI3AgEMMUwwSqAkgCIA
# TQBpAGMAcgBvAHMAbwBmAHQAIABXAGkAbgBkAG8AdwBzoSKAIGh0dHA6Ly93d3cu
# bWljcm9zb2Z0LmNvbS93aW5kb3dzMA0GCSqGSIb3DQEBAQUABIIBAG8hL1XYldVM
# HbuclPJJcgBICzeuwxg5GaPr3rkIxi/3AkCPrO3hsiOT+KSoBa38Wa0TCy2b32ig
# eVj0/ovjntRauvis5BDJjKouIBeLlPwK/Vf/cuomTpIKvpYgInS6UCw1EwkrLC9H
# 0e98pL4qPLu5ifWAQbJ/TAStF2dm7/7wkjnDAsudNfQkgnwS6AHMuG2zBoZK4Wzj
# 5yq2LAFuioLYKrj/yaK+0kJ51pOSt6rAYZ/NHLPDXqAyVDp/6dw+SrOT7H/GFp50
# 7JxCsd4ZvZetakZNdD05znVRaUctXkO89cKD3W+GXKkhWycoDI6zPZ/PPYdQ1lAR
# Bk39xRBggSWhggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkG
...
# ODA1MDMwOTA0MjRaMCMGCSqGSIb3DQEJBDEWBBROg3CyP0CpHSoCFqMXMP4aZl/F
# mDANBgkqhkiG9w0BAQUFAASCAQCJwLhBTJnq/Hgn33SqOD1Jla8d9BZNhqZUsNNu
# XcGp952vGviFESnF1uPHbXj5IUVPzW2CUre6+XnVnBIg3f9f64QJt7tAjDWGMS2S
# B6W9C1M1bCr5Tt6s6MTGgka1COiPMQiRG5DhbmPwCcOqgxIYY0ItOm9OmMrKKZW1
# wP/ghZecbifppMWC3rfrnGkur73amCSweNNLRpGeU1ws4CfM4hfx3HGQZloVFEj4
# ilYlrOubXyBsQ8S2XnId0XFLb3oKkADbGobH67ocek64QuapTTgxQLeqelaTbLVq
# oiHKI5QiEJG1P1g5ui2NFOdXidJZTBmbCIOwVfDXLNKuosFb
